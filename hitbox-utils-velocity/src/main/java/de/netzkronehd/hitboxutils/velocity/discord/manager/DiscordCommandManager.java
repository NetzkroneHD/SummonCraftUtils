package de.netzkronehd.hitboxutils.velocity.discord.manager;
...
import de.netzkronehd.hitboxutils.velocity.discord.command.DeleteVerifySlashCommand;
import de.netzkronehd.hitboxutils.velocity.discord.command.VerifySlashCommand;
...
public class DiscordCommandManager extends Manager {
    ...
    public void registerCommand(Command command, BotSlashCommand slashCommand) {
        ...
        log("Command '{}' was registered.", command.getName());
    }
