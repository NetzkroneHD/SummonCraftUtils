...
public class PunishCommand extends HitBoxCommand {
        ...
        try {
            ...
            if (ht != null) {
                ...
                hitBoxUtils.runAsync(() -> {
                    createPunishment(type, timePunishment, ht.getUniqueId(), ht.getName(), hp);
                });
            } else {
                hitBoxUtils.runAsync(() -> {
    ...
    private void createPunishment(PunishmentType type, TimePunishment timePunishment, UUID uuid, String name, HitBoxPlayer player) {
        ...
        hitBoxUtils.getProxyServer().getCommandManager().executeAsync(hitBoxUtils.getProxyServer().getConsoleCommandSource(), commandLine);
