package de.netzkronehd.hitboxutils.sound;
...
public enum GlobalSound {
    ...
    public static Optional<GlobalSound> of(String name) {
        try {
            return Optional.of(GlobalSound.valueOf(name));
