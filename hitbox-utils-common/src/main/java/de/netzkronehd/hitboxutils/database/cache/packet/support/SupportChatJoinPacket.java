...
@Getter
@EqualsAndHashCode
public class SupportChatJoinPacket extends HitBoxPacket {

    private final SupportChatModel supportChatModel;
    private final TeamUserModel user;

    public SupportChatJoinPacket(String source, SupportChatModel supportChatModel, TeamUserModel user) {
        super(source);
